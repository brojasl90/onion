...
namespace Web.Utils
{
    public class Log
    {
        ...
        {
            StringBuilder msg = new StringBuilder();
            msg.AppendFormat("----------------------------------------------------------\n\n"); msg.AppendFormat("Fecha del Error {0}\n", DateTime.Now.ToString("dd-MM-yy hh: mm:ss")); msg.AppendFormat("1- Clase: {0}\n\n", pMethodBase.DeclaringType);
        ...
        private static string GetDetailsSQLException(SqlException pExcepcion)
        {
            ...
            msg.AppendFormat("\n");
            msg.AppendFormat("StackTrace {0}\n\n", pExcepcion.StackTrace);
            msg.AppendFormat(@"Info de errores para investigar mashttps://technet.microsoft.com/en-us/library/cc645603(v=sql.105).aspx");
            msg.AppendFormat("---------------------------------------------------------\n");
            return msg.ToString();
        }
